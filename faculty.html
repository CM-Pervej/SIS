...
<head>
    ...
    <title>Faculties of Jashore University of Science and Technology</title>
...
<body>
    ...
    <div style="position: sticky; top: 0px; z-index: 10000;">
        <nav class="navbar bg-dark-purple">
            <div class="container-fluid d-flex justify-content-end align-items-center">
                <div class="w-100 m-0">
                    <p id="delayedText" class="m-0 p">Faculties of Jashore University of Science and Technology</p>
                </div>
            </div>
        </nav>
    ...
    <div style="z-index: -1;">
        ...
        <div class="fixed4">
            <div class="fixed4-content">
                <div>
                    <div class="row" style="margin: 2%;">
                        <div class="col-xl-4 mt-3" onclick="window.location.href='faculty/Fa1. E and T.php'">
                            <div class="card2">
                                <div class="card2-body">
                                    <i>Faculty of</i>
                                    <h4 class="card2-title mt-2">Engineering and Technology</h4>
                                    <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 mt-3" onclick="window.location.href='faculty/Fa2. A S n T.php'">
                            <div class="card2">
                                <div class="card2-body">
                                    <i>Faculty of</i>
                                    <h4 class="card2-title mt-2">Applied Science and Technology</h4>
                                    <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 mt-3" onclick="window.location.href='faculty/Fa3. B S n T.php'">
                            <div class="card2">
                                <div class="card2-body">
                                    <i>Faculty of</i>
                                    <h4 class="card2-title mt-2">Biological Science and Technology</h4>
                                    <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" style="margin: 2%;">
                        <div class="col-xl-4 mt-3" onclick="window.location.href='faculty/Fa4. H S.php'">
                            <div class="card2">
                                <div class="card2-body">
                                    <i>Faculty of</i>
                                    <h4 class="card2-title mt-2">Health Science</h4>
                                    <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 mt-3" onclick="window.location.href='faculty/Fa5. A n S S.php'">
                            <div class="card2">
                                <div class="card2-body">
                                    <i>Faculty of</i>
                                    <h4 class="card2-title mt-2">Arts and Social Science</h4>
                                    <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 mt-3" onclick="window.location.href='faculty/Fa6. S.php'">
                            <div class="card2">
                                <div class="card2-body">
                                    <i>Faculty of</i>
                                    <h4 class="card2-title mt-2">Science</h4>
                                    <small class="card2-text"><hr><a href=""><b>VISIT WEBSITE</b></a></small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" style="margin: 2%;">
                        <div class="col-xl-4 mt-3" onclick="window.location.href='faculty/Fa7. B S.php'">
                            <div class="card2">
                                <div class="card2-body">
                                    <i>Faculty of</i>
                                    <h4 class="card2-title mt-2">Business Studies</h4>
                                    <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                                </div>
                            </div>
                        </div>
