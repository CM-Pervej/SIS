...
<head>
  ...
  <title>Faculty of Arts and Social Science</title>
  ...
  <div style="position: sticky; top: 0px; z-index: 10000;">
    <nav class="navbar bg-dark-purple">
      <div class="container-fluid d-flex justify-content-end align-items-center">
        <div class="w-100 m-0">
          <p id="delayedText" class="m-0 p">Faculty of Arts and Social Science</p>
        </div>
      </div>
    </nav>  
          ...
          <div>
            <div>
                <div class="row" style="margin: 2%;">
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/english.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">English</h4>
