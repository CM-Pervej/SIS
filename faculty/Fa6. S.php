          ...
          <div>
            <div>
                <div class="row" style="margin: 2%;">
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/chemistry.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Chemistry</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div> 
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/mathematics.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Mathematics</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/physics.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Physics</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div>                 
