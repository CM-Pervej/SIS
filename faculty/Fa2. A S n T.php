...
<head>
  ...
  <title>Faculty of Applied Science and Technology</title>
  ...
  <div style="position: sticky; top: 0px; z-index: 10000;">
    <nav class="navbar bg-dark-purple">
      <div class="container-fluid d-flex justify-content-end align-items-center">
        <div class="w-100 m-0">
          <p id="delayedText" class="m-0 p">Faculty of Applied Science and Technology</p>
        </div>
      </div>
    </nav>  
                ...
                <button type="button" class="btn btn-light containerr">
                            <a href="#" style="text-align: right;" class="span"><b>FACULTY</b></a>
                                <big class="contentt">
                                    ...
                                    <a href="Fa7. B S.php" class="cardd" style="padding: 0px;">
                                        <div class="cardd-body">
          ...
          <div>
            <div>
                <div class="row" style="margin: 2%;">
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/appt.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Agro Product Processing Technology</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div> 
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/cdm.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Climate and Disaster Management</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/est.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Environmental Science and Technology</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div>                 
                ...
                <div class="row" style="margin: 2%;">               
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/nft.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Nutrition and Food Technology</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div>
