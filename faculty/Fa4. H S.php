...
<head>
  ...
  <title>Faculty of Health Science</title>
  ...
  <div style="position: sticky; top: 0px; z-index: 10000;">
    <nav class="navbar bg-dark-purple">
      <div class="container-fluid d-flex justify-content-end align-items-center">
        <div class="w-100 m-0">
          <p id="delayedText" class="m-0 p">Faculty of Health Science</p>
        </div>
      </div>
    </nav>  
          ...
          <div>
            <div>
                <div class="row" style="margin: 2%;">
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/nhs.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Nursing and Health Science</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div> 
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/pess.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Physical Education and Sports Science</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mt-3" onclick="window.location.href='../department/pr.php'">
                        <div class="card2">
                            <div class="card2-body">
                                <i>Department of</i>
                                <h4 class="card2-title mt-2">Physiotherapy and Rehabilitation</h4>
                                <small class="card2-text"><hr><a href="#"><b>VISIT WEBSITE</b></a></small>
                            </div>
                        </div>
                    </div>                 
