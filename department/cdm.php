<?php
   ...
   $query = "select * from students where department = 'Climate and Disaster Management'";
...
<head>
  ...
  <title>Climate and Disaster Management</title>
  ...
  <div style="position: sticky; top: 0px; z-index: 10000;">
    <nav class="navbar bg-dark-purple">
      <div class="container-fluid d-flex justify-content-end align-items-center">
        <div class="w-100 m-0">
          <p id="delayedText" class="m-0">Climate and Disaster Management</p>
        </div>
      </div>
    </nav>  
