<?php
   ...
   $query = "select * from students where department = 'Agro Product Processing Technology'";
...
<head>
  ...
  <title>Agro Product Processing Technology</title>
  ...
  <div style="position: sticky; top: 0px; z-index: 10000;">
    <nav class="navbar bg-dark-purple">
      <div class="container-fluid d-flex justify-content-end align-items-center">
        <div class="w-100 m-0">
          <p id="delayedText" class="m-0">Agro Product Processing Technology</p>
        </div>
      </div>
    </nav>  
