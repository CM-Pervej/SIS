<?php
   ...
   $query = "select * from students where department = 'Nursing and Health Science'";
...
<head>
  ...
  <title>Nursing and Health Science</title>
  ...
  <div style="position: sticky; top: 0px; z-index: 10000;">
    <nav class="navbar bg-dark-purple">
      <div class="container-fluid d-flex justify-content-end align-items-center">
        <div class="w-100 m-0">
          <p id="delayedText" class="m-0">Nursing and Health Science</p>
        </div>
      </div>
    </nav>  
